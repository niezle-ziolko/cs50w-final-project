        ...
        <div className="h-25 w-full grid gap-1 overlay-y-scroll overlay-x-hidden overflow-x-hidden">
          {chapters.length > 0 ? (
            chapters.map((chapter, index) => {
              ...
              const baseClass = "p-1 text-primary text-center bg-transparent font-bold border-2 rounded-sm cursor-pointer hover:shadow-none hover:transform-none active:shadow-none active:transform-none";
